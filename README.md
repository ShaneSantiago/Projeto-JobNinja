...
<!-- PROJECT TITLE -->
<h1 align='center'id="top"> :rocket: == JobNinja == :rocket: </h1>


<!-- PROJECT SOBRE -->
<h2 id="sobre">:notebook: Sobre </h2>
<p align="justify">Nele você consegue cadastrar um serviço, procurar algum serviço e para facilitar a busca, tem os filtros em que você pode escolher por titulo, preço, descrição</p>

<!-- PROJECT SITE -->
<h2 id="site">:earth_americas: Link do site </h2>
<p>🔗 <a href="https://numerous-moon.surge.sh/" target="_blank"> JobNinjas </a>  </p>
<!-- <a href="https://numerous-moon.surge.sh/" onclick="return ! window.open(this.href);"> Open in a new window</a> -->
